...
public class IndexPackageImpl extends EPackageImpl implements IndexPackage {
	...
	public EAttribute getRelationShipLink_Cardinality() {
		return (EAttribute)relationShipLinkEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getRelationShipLink_IsIndentifier() {
		return (EAttribute)relationShipLinkEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		relationShipLinkEClass = createEClass(RELATION_SHIP_LINK);
		createEAttribute(relationShipLinkEClass, RELATION_SHIP_LINK__CARDINALITY);
		createEAttribute(relationShipLinkEClass, RELATION_SHIP_LINK__IS_INDENTIFIER);
	...
	public void initializePackageContents() {
		...
		relationShipEClass.getESuperTypes().add(this.getNode());
		...
		initEReference(getLink_Source(), this.getEntity(), null, "source", null, 0, 1, Link.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getLink_Target(), this.getRelationShip(), null, "target", null, 0, 1, Link.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getRelationShipLink_Cardinality(), ecorePackage.getEString(), "cardinality", null, 0, 1, RelationShipLink.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRelationShipLink_IsIndentifier(), ecorePackage.getEBooleanObject(), "isIndentifier", null, 0, 1, RelationShipLink.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
